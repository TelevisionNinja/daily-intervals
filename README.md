...
If the starting time is well after the current time, the interval will not wait until the current time has reached the starting time to execute the callback function. The closest interval will be used as the time to execute the function.
